"""
Cake Album Operations Platform v1.4 — Release 5.0 (Batch Baking)
...
APP_VERSION = "v1.4 — Release 5.0 (Batch Baking)"
...
def render_decoration():
    ...
    with t2:
        ...
        if row is not None:
            ...
            if st.button("Submit Material Requirement", width='stretch'):
                if item and qty > 0:
